...
const New = [
  ...
  },
  {
    ...
    seriesLogo: TMDLOGO,
    description: 'El regreso de TheMarioDimension. Despues de 11 años, Rodrigo regresa a platicarnos no solo de su estado actual, sino tambien de su trayectoria en YouTube. No tengo palabras para describir lo afortunado que me siento de traerles esta entrevista. Gracias @TheZeldaDimension por tomarte el tiempo de participar en este proyecto! Gracias a @ElHasb y @ELROJIZO54 por ayudar en la parte visual y en las preguntas. Y a @LeBasth por la miniatura.',
  },
  {
    id: 6,
    section: 'Creepy',
